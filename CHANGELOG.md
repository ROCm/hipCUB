...
* Add -t smoke option in retest.py. It will run a subset of tests such that the total test time is in 5 minutes. Use python3 ./rtest.py --test smoke or python3 ./rtest.py --t smoke to execute smoke test.
### Changed
